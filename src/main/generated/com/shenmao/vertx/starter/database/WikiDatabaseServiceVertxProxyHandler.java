...
import io.vertx.core.AsyncResult;
import io.vertx.core.Handler;
import com.shenmao.vertx.starter.configuration.SqlQueriesConfig.SqlQuery;
    ...
    try {
      ...
      switch (action) {
        ...
        case "fetchAllPagesCondition": {
          service.fetchAllPagesCondition(json.getValue("start") == null ? null : (json.getLong("start").intValue()), (java.lang.String)json.getValue("articleStatus"), createListHandler(msg));
          break;
        }
        case "fetchPage": {
          service.fetchPage(json.getValue("id") == null ? null : (json.getLong("id").longValue()), (java.lang.String)json.getValue("articleName"), createHandler(msg));
          break;
        }
        case "createPage": {
          service.createPage(json.getValue("timestamp") == null ? null : (json.getLong("timestamp").longValue()), (io.vertx.core.json.JsonObject)json.getValue("articleObject"), createHandler(msg));
          break;
        }
        case "savePage": {
          service.savePage(json.getValue("timestamp") == null ? null : (json.getLong("timestamp").longValue()), (java.lang.String)json.getValue("articleFileName"), (io.vertx.core.json.JsonObject)json.getValue("data"), createHandler(msg));
          break;
        }
        case "deletePage": {
        ...
        case "fetchLastIncrementId": {
          service.fetchLastIncrementId(createHandler(msg));
          break;
        }
        default: {
